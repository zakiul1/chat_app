...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-sky-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="#" className="flex ms-2 md:me-24">
                <img src="./z-chat.png" className="h-8 me-3" alt="FlowBite Logo" />
                <span className="self-center text-xl text-gray-500 font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Z Chat</span>
              </a>
            </div>
